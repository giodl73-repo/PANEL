...
async function loadReviewerProfile(name, options = {}) {
    ...
    // Plugin is source of truth; local .roles/panel-reviewer is extensions only
    const pluginReviewersPath = projectConfig.pluginReviewersPath; // ${pluginRoot}/.roles/panel-reviewer
    const localReviewersPath = projectConfig.localReviewersPath || '.roles/panel-reviewer';
