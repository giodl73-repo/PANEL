...
| ready | `REVIEW_PANEL.md` completed by `panel:module review` AND all PP1 items addressed |
...
- **ready_handler**: Check REVIEW_PANEL.md from panel:module review, verify PP1 items addressed
