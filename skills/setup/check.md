...
- Reviewer profiles accessible via `${pluginRoot}/.roles/panel-reviewer/`
...
Reviewer Profiles (${pluginRoot}/.roles/panel-reviewer/):
  ✓ _index.yaml           accessible (name → R-N registry)
  ✓ R-N.md profiles       51 profiles (OLE format)
  — .roles/panel-reviewer/   (local extensions, optional)
