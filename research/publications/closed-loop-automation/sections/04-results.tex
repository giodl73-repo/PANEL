...
\subsection{Author Experience and Trust}
...
\textbf{Perceived control}:
\begin{itemize}
\item 5 of 7 authors reported feeling they maintained adequate control: "I reviewed every edit before accepting, so I felt in charge."
\item 2 of 7 expressed concern about passive deference: "After the first few edits were correct, I stopped reading them carefully and just approved."
\end{itemize}

\textbf{Trust in edits}:
\begin{itemize}
\item 6 of 7 authors trusted mechanical corrections (typos, citations) without careful review.
\item 3 of 7 authors were skeptical of phrasing changes: "I often modified the suggested phrasing to match my voice."
\item 1 author noted: "I felt like I was editing AI text rather than revising my own work."
\end{itemize}

\textbf{Satisfaction}:
\begin{itemize}
\item All 7 authors reported satisfaction with time savings (64\% reduction).
\item 4 of 7 noted missing the learning opportunity: "Manual revision helped me see patterns in my writing weaknesses. Automation is faster but I learn less."
\item 3 of 7 requested selective automation: "I want the system to handle typos automatically but flag phrasing changes for my review."
\end{itemize}

These findings suggest a tension between efficiency and agency. Authors value time savings but want more transparency (why was this edit suggested?) and selective control (automate some tasks, flag others). This informs the design principles discussed in Section~\ref{sec:discussion}.