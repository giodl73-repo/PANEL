# Revision Plan: A Controlled Study of Milk Immersion Timing for Optimal Cookie Texture

**Paper**: panel-dunk-methodology
**Round**: 2 → 3
**Date**: 2026-01-25
...
**Action**:
- [x] Strengthen methodology section with additional controls
- [x] Add justification for design choices
...
**Raised by**: 3 reviewers
**Action**:
- [x] Implement two baseline comparisons
- [x] Add results table comparing approaches
**Target section**: sections/01-introduction.tex
...
### P3.1: Figure quality
- [x] Improve figure resolution and labeling
